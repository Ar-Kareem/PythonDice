...
from src.funclib import absolute
def test_absolute():
...
from src.funclib import contains
def test_contains():
...
from src.funclib import count_in
def test_count_in():
...
from src.funclib import reverse_VANILLA_SLOW as reverse
...
from src.funclib import reverse
def test_reverse():
    assert 1 @ Seq(range(1, 7)) == 1, 'reverse [in docs]'
    assert 1 @ reverse(Seq(range(1, 7))) == 6, 'reverse [in docs]'
    assert RV.dices_are_equal(reverse(roll(2, 6)), roll(2, 6)), 'reverse [in docs]'  # type: ignore
...
from src.funclib import maximum_of
def test_maximum_of():
...
from src.funclib import explode
def test_explode():
...
from src.funclib import highest_N_of_D
...
# TODO complete these test
from src.funclib import lowest_N_of_D
...
# TODO complete these test
from src.funclib import middle_N_of_D
...
# TODO complete these test
from src.funclib import highest_of_N_and_N
...
# TODO complete these test
from src.funclib import lowest_of_N_and_N
...
from src.funclib import sort_VANILLA_SLOW, sort
